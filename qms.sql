...
(22, 'EncoderW1', 'Regular', '11-2221', 'Encode', 2, 1, 'REGULAR', 'ACTIVE', 'APPROVED', '$2y$10$TwmU.fdsV84Ix2IjqDk68eRO3rxI3hEnIyoAQp3G76g7kYdo6Lcay', NULL),
...
(30, 'Release', 'W3', '11-4443', 'Release', 4, 3, 'BOTH', 'ACTIVE', 'APPROVED', '$2y$10$1LwA6QlDO9BO00HXHK9BguwpDOGUx/LT7rC/h7nWM9eRx2CKDKt.a', NULL),
...
(43, 'Display3', 'Regular', '11-5553', 'Display', NULL, NULL, 'REGULAR', 'INACTIVE', 'APPROVED', '$2y$10$iJkaohgeOowWt16zjZd.Re4R2pTSReDDn57mb306tYyVAwXsqzRUS', NULL),
(44, 'Display4', 'Priority', '11-5554', 'Display', NULL, NULL, 'PRIORITY', 'INACTIVE', 'APPROVED', '$2y$10$..3CfmAWHU84bqheL737quNqeZYJvMGKOYuStYrWzxjfpb0g5zpEu', NULL);
...
CREATE DEFINER=`root`@`localhost` EVENT `auto_delete_transactions` ON SCHEDULE EVERY 1 DAY STARTS '2025-06-19 11:27:00' ON COMPLETION NOT PRESERVE ENABLE DO DELETE FROM tbl_transactions$$
