    ...
    public function login()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if ($result && password_verify($password, $result->user_pass)) {
                ...
                if (($result->section_id == 15) && ($result->user_type == 'QSF') && ($result->ass_step == 2)) {
                    redirect(base_url('qsf'));
                } elseif (($result->section_id == 15) && ($result->user_type == 'QSF') && ($result->ass_step == 3)) {
                    redirect(base_url('qsfS3'));
                } elseif (($result->section_id == 15) && ($result->user_type == 'QSF') && ($result->ass_step == 4)) {
                    redirect(base_url('qsfS4'));
                } elseif (($result->section_id == 15) && ($result->user_type == 'QND')) {
                    redirect(base_url('qnd'));
                } elseif (($result->section_id == 15) && ($result->user_type == 'QSD')) {
