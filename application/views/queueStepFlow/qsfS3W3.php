      ...
      <div class="col-4 h-100">
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col">
              <button class="btn btn-secondary btn-lg call3dBtn my-2 w-100" onclick="s3w3CallBtn()" id="callBtnID">
...
<script>
  ...
  function s3w3CallBtn() {
    if ($('#s3w3Serving').html().trim() !== '' && !$('#callBtnID').prop('disabled')) {
      isCallCooldown = true;
      $('#callBtnID').prop('disabled', true);
