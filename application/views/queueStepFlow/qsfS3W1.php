      ...
      <div class="col-8">
        <div class="row h-100">
          ...
          <div class="col-lg-4" style="padding-right:0;">
            ...
            <div class="row m-0 h-100">
              <div class="card" style="background-color:#edf6f9; height:75vh;">
                <div class="card-body text-center overflow-auto" id="s3w1autoDQRegu">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" style="padding-right:0;">
            ...
            <div class="row m-0 h-100">
              <div class="card" style="background-color:#edf6f9; height:75vh;">
                <div class="card-body text-center overflow-auto" id="s3w1autoDQPrio">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" style="padding-right:0;">
            ...
            <div class="row m-0 h-100">
              <div class="card" style="background-color:#edf6f9; height:75vh;">
                <div class="card-body text-center overflow-auto" id="s3w1autoDP">
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-4 h-100">
        <div class="card" style="background: rgb(27, 75, 176, 0.9); border-bottom-right-radius: 20px; border-top-left-radius: 20px;">
          <div class="card-body text-center" style="border-radius:20px;">
            <h3 class="qsfHeaderFont">SERVING STEP 3 WINDOW 1</h3>
          </div>
        </div>
        ...
        <div class="row m-0 h-75">
          <div class="h-100 cardCstmS3" style="padding:0;">
            ...
            <div id="nowServ" class="card-body text-center h-75">
              <div class="col h-75 d-flex align-items-center justify-content-center" id="s3w1Serving">
              </div>
            </div>
...
<script>
  ...
  function loadStepFlow() {
    $.ajax({
      url: '<?= base_url('s3w1ServingRou') ?>',
      type: 'GET',
      success: function(data) {
        $('#s3w1Serving').html(data);
        if ($('#s3w1Serving').html().trim() !== '') {
...
<script>
  ...
  function s3w1CallBtn() {
    if ($('#s3w1Serving').html().trim() !== '' && !$('#callBtnID').prop('disabled')) {
      isCallCooldown = true;
      $('#callBtnID').prop('disabled', true);
