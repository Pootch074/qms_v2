    ...
    <div class="container-fluid h-100">
        <div class="row h-100 pt-1" style="background: rgb(12,48,128); background: linear-gradient(180deg, rgba(12,48,128,1) 0%, rgba(28,75,178,1) 82%, rgba(101,130,194,1) 100%);">
            <div class="col-6 text-center border d-flex flex-column">
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="s2">
                    </div>

                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center">
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="s3w1">
                    </div>
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="s3w2">
                    </div>
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="s3w3">
                    </div>
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    ...
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="s4w1">
                    </div>
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    ...
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="s4w2">
                    </div>
            ...
            <div class="col-6 text-center border" style="background: rgb(12,48,128); background: linear-gradient(180deg, rgba(12,48,128,1) 0%, rgba(28,75,178,1) 82%, rgba(101,130,194,1) 100%);">
                <div class="cardCstm flex-grow-1 mb-1 d-flex">
                    <video width="100%" height="auto%" autoplay loop muted>
                        <source src="assets\resources\qsdVideos\dsw.mp4" type="video/mp4">
...
<script>
    $(document).ready(function() {
        // Object to store previous data for each step
        let prevData = {};
        ...
        function handleQueueData(url, elementID, step) {
            $.ajax({
                url: url,
                type: 'GET',
                success: function(data) {
                    ...
                    if (h1.length > 0) {
                        ...
                        if (parts.length === 2) {
                            ...
                            // Initialize previous data for this step if not already
                            if (!prevData[url]) {
                                prevData[url] = {
                                    queueNum: null,
                                    category: null
        ...
        function qsdLoadStepFlow() {
            handleQueueData('<?= base_url('s2Rou') ?>', '#s2', 2);
            handleQueueData('<?= base_url('s3w1Rou') ?>', '#s3w1', 3);
            handleQueueData('<?= base_url('s3w2Rou') ?>', '#s3w2', 3);
            handleQueueData('<?= base_url('s3w3Rou') ?>', '#s3w3', 3);
            handleQueueData('<?= base_url('s4w1Rou') ?>', '#s4w1', 4);
            handleQueueData('<?= base_url('s4w2Rou') ?>', '#s4w2', 4);

            handleQueueData('<?= base_url('qsdStep3Prio') ?>', '#qsdDSStep3Prio', 3);
            handleQueueData('<?= base_url('qsdStep4') ?>', '#qsdDSStep4', 4);
        }
        ...
        function qsdLoadStepFlowWithDelay() {
            qsdLoadStepFlow(); // Call to fetch and handle queue data
            // Repeat the call after a reasonable delay (adjust delay time if necessary)
