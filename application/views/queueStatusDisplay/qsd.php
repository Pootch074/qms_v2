        ...
        <div class="row h-100 pt-1" style="background: rgb(12,48,128); background: linear-gradient(180deg, rgba(12,48,128,1) 0%, rgba(28,75,178,1) 82%, rgba(101,130,194,1) 100%);">
            <div class="col-6 text-center border d-flex flex-column">
                ...
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    ...
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" id="step2ReguID" style="background-color:pink;">
                    </div>

                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center" style="background-color:pink;">
                    </div>
                </div>
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col col-lg-8 h-100 d-flex align-items-center justify-content-center" id="qsdDSStep3">
                    </div>
                </div>
                <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between">
                    <div class="col col-lg-4 h-100 d-flex align-items-center justify-content-center">
                    ...
                    <div class="col col-lg-8 h-100 d-flex align-items-center justify-content-center" id="qsdDSStep4">
...
<script>
    $(document).ready(function() {
        ...
        function qsdLoadStepFlow() {
            handleQueueData('<?= base_url('qsdStep2Prio') ?>', '#step2PrioID', 2);
            handleQueueData('<?= base_url('qsdStep2Regu') ?>', '#step2ReguID', 2);
            handleQueueData('<?= base_url('qsdStep3') ?>', '#qsdDSStep3', 3);
