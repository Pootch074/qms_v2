            ...
            <div class="col-6 text-center border d-flex flex-column" style="background:;">
                ...
                <?php if (isset($queStep) && !empty($queStep)): ?>
                    <?php foreach ($queStep as $row): ?>
                        <div class="cardCstm flex-grow-1 mb-1 d-flex align-items-center justify-content-between" style="background-color:red;">
                            ...
                            <div class="col col-lg-8 h-100 d-flex align-items-center justify-content-center" id="qsdQueueNum" style="background-color:yellow;">
                                <h1>
