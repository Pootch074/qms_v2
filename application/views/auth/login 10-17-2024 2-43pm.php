    ...
    <div class="container" style="background-color:;">
      ...
      <section style="background-color:;" class="section register min-vh-100 d-flex flex-column align-items-center justify-content-center py-1">
        <div class="row justify-content-center">
          <div class="col-lg-8 col-sm-8 d-flex flex-column align-items-center justify-content-center">
                ...
                <form class="row g-3 needs-validation" action="<?php echo base_url('login'); ?>" method="post">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group has-validation">
                      <input type="text" name="employee_id" class="form-control" id="employeeID" value="<?php echo set_value('employee_id'); ?>" required>
