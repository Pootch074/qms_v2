    ...
    <form class="row g-3 needs-validation" action="<?php echo base_url('register') ?>" method="post" autocomplete="off">
      ...
      <div class="col-left">
        <div class="input-field">
          <input type="text" name="emp_id" id="empID" value="<?php echo set_value('emp_id'); ?>" required>
          <label for="empID">Employee No.</label>
          <div class="invalid-feedback">
            Please enter your employee ID!
          </div>
        </div>
        <div class="input-field">
          <input type="text" name="f_name" id="fname" value="<?php echo set_value('f_name'); ?>" required>
        ...
        <div class="input-field">
          <input type="text" name="l_name" id="lname" value="<?php echo set_value('l_name'); ?>" required>
